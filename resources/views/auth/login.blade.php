...
<head>
  ...
  <style>
    ...
    *::after {
    ...
    .panel.active {
      display: block;
      animation: fadeSwitch .25s ease both;
    }
    ...
    .success-banner {
      ...
      border: 1.5px solid rgba(90, 154, 106, .3);
      border-radius: 10px;
      padding: 12px 16px;
      font-size: .78rem;
      color: var(--done);
    ...
    .error-banner {
      ...
      border: 1.5px solid rgba(201, 99, 122, .25);
      border-radius: 10px;
      padding: 12px 16px;
      font-size: .78rem;
      color: var(--accent);
...
<body>
      ...
      <div class="panel active" id="panel-login">
        ...
        <div class="field" id="lf-password">
          ...
          <div class="input-wrap">
            ...
            <input type="password" id="l-password" class="has-eye" placeholder="••••••••"
      ...
      <div class="panel" id="panel-register">
        ...
        <div class="field" id="rf-password">
          ...
          <div class="input-wrap">
            ...
            <input type="password" id="r-password" class="has-eye" placeholder="••••••••" autocomplete="new-password"
  ...
  <script>
    ...
    function toggleTheme() {
      ...
      localStorage.setItem('theme', newTheme);  // ← idagdag ito
